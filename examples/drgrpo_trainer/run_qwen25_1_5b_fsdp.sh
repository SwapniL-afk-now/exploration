...
TRAIN_FILE=${TRAIN_FILE:-/workspace/failure-escape-runs/data/dapo_math_17k_train_256.parquet}
NNODES=${NNODES:-1}
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen25_1_5b_drgrpo_fsdp-${RUN_TIMESTAMP}}
