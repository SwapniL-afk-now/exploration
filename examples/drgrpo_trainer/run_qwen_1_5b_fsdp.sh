#!/usr/bin/env bash
# Dr.GRPO | DeepSeek-R1-Distill-Qwen-1.5B | FSDP training | NVIDIA GPUs
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-deepseek_r1_distill_qwen_1_5b_drgrpo_fsdp-${RUN_TIMESTAMP}}
