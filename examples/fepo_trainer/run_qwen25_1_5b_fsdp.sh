#!/usr/bin/env bash
# FEPO | Qwen2.5-1.5B-Instruct | experimental single-GPU LoRA trainer | NVIDIA GPUs
...
OUTPUT_DIR=${OUTPUT_DIR:-checkpoints/fepo/dapo/qwen25_1_5b/${RUN_TIMESTAMP}}

PROJECT_NAME=${PROJECT_NAME:-failure-escape}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen25-1.5b-fepo-dapo-fsdp-${RUN_TIMESTAMP}}
...
TRAIN_PROMPT_BATCH_SIZE=${TRAIN_PROMPT_BATCH_SIZE:-16}
...
FAILURE_LEARNING_RATE=${FAILURE_LEARNING_RATE:-1e-6}
