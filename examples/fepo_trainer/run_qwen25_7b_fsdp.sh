#!/usr/bin/env bash
# FEPO | Qwen2.5-7B-Instruct | experimental single-GPU LoRA trainer | NVIDIA GPUs
...
OUTPUT_DIR=${OUTPUT_DIR:-checkpoints/fepo/dapo/qwen25_7b/${RUN_TIMESTAMP}}

PROJECT_NAME=${PROJECT_NAME:-failure-escape}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen25-7b-fepo-dapo-fsdp-${RUN_TIMESTAMP}}
