...
OUTPUT_DIR=${OUTPUT_DIR:-checkpoints/fepo/dapo/qwen25_math_1_5b/${RUN_TIMESTAMP}}

PROJECT_NAME=${PROJECT_NAME:-failure-escape}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen25-math-1.5b-fepo-dapo-fsdp-${RUN_TIMESTAMP}}
